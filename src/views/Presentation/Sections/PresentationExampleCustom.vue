        ...
        <div class="row justify-content-center text-center my-sm-5">
          <div class="col-lg-6">
            <MaterialBadge color="success" class="mb-3"
              >personal projects</MaterialBadge
            >

            <h2 class="text-dark mb-0">Example Of My Personal Project</h2>
            <p class="lead">
              I didn't put my client project because there are not for publish
            </p>
          </div>
        </div>
      </div>
